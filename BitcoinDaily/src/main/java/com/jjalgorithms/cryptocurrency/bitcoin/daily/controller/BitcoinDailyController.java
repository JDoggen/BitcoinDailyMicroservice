...
import com.jjalgorithms.cryptocurrency.bitcoin.daily.dto.BitcoinDailyDto;
import com.jjalgorithms.cryptocurrency.bitcoin.daily.model.BitcoinDaily;
import com.jjalgorithms.cryptocurrency.bitcoin.daily.service.IBitcoinDailyService;
...
public class BitcoinDailyController {
	...
	@GetMapping("/api/bitcoindaily/scrape/stopautomatedscraping")
	...
	private boolean isScraping() {
		return this.iBitcoinDailyService.isScraping();
	}
	
	@GetMapping("api/bitcoindaily/firstentry")
	private String firstEntry() {
		String firstEntry = this.iBitcoinDailyService.firstEntry();
		return firstEntry;
	}
